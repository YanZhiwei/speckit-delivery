...
The command is complete when every configured path and command was verified or explicitly left unset with a reason, and the owner has a reviewable quality-profile gap list.
